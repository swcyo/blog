...
作为研究生，我们不要用这么笨拙的办法，现在有很多文献管理软件，最出名的是Endnote，网上教程也很多，不过毕竟不是国产软件软件，对中文的支持就会有偏差，而且没有国产数据库的支持，如果你要完美显示中英文混排的参考文献，你需要先去下载国标的参考文献style，还要设置两个作者的list，这里有两个教程。
...
各级标题采用逐级缩进形式，每级缩进2字符（三级目录，一级为0字符，二级为2字符，三级为4字符）

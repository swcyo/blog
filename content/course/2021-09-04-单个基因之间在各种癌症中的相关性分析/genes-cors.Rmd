...
## 使用read.delim函数直接导入tsv文件
data <- read.delim("~/Documents/GitHub/blog/content/course/2021-09-04-单个基因之间在各种癌症中的相关性分析/denseDataOnlyDownload.tsv")
## 重命名基因名
colnames(data)[5:7]<-c('ATR','CHEK1','TFAM') 
## 提取特定的四种癌症类型
need <- subset(data, cancer.type.abbreviation %in% c('COAD','OV','PAAD','UCEC'))
```
...
```{r cor1, fig.align='center', fig.cap="ATR和TFAM在四种癌症中的pearson相关性分析", fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
library(ggstatsplot)

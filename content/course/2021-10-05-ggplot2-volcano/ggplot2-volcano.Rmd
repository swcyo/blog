...
```{r include=FALSE}
library(readr)
demo <- read_csv("/Users/mac/Documents/GitHub/blog/content/course/2021-10-05-ggplot2-volcano/demo.csv")
```

```{r echo=FALSE, warning=FALSE}
knitr::kable(demo[1:50,],caption = "Demo数据")
```
...
```{r echo=FALSE}
knitr::kable(demo[1:20,],caption = "去除NA值和重复值后的前50列Demo数据")
```
...
```{r echo=F}
knitr::kable(demo[1:15,],caption = "定义显示标签的基因")
```

...
```{r ,echo=FALSE}
shz<-read.csv('/Users/mac/Documents/GitHub/blog/content/course/2022-08-26-ncovshz/shz.csv')
knitr::kable(shz,caption = "2022年8月至今石河子疫情趋势")
```
...
```{r,echo=FALSE}
knitr::kable(long[1:10,],caption = "长数据转换后结果")
```

...
以[仙桃学术](https://www.xiantaozi.com/)上的一个诊断性ROC[示例数据](https://bioinfomatics.xiantao.love/biotools/data/demo/test/rocPlot/ROC%E6%9B%B2%E7%BA%BF.xlsx)为例进行演示~~（下载请点击[xlxs链接](https://xt-biotools.oss-cn-hangzhou.aliyuncs.com/biotools-v3/data/public/demo/%E8%AF%8A%E6%96%ADROC.xlsx)）~~。
